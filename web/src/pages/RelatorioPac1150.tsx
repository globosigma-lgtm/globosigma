...
export function RelatorioPac1150() {
  ...
  function abrirRelatorio() {
    ...
    window.open(`/relatorios/pac-1150/imprimir?${params.toString()}`, "_blank");
  }
  ...
  return (
    <div>
      <div className="page-header">
        <div>
          <h1>FORM PAC 001_1150 — Manutenção</h1>
          <div className="page-header__desc">
            Relatório semanal auditável dos planos de manutenção executados via OS, com checklist de parâmetros por equipamento
          </div>
        </div>
      </div>
