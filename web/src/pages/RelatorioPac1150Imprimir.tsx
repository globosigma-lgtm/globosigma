...
export function RelatorioPac1150Imprimir() {
  ...
  useEffect(() => {
    ...
    api
      .get<RelatorioPac>(`/relatorios/pac-1150?${query.toString()}`)
      .then(setRelatorio)
    ...
    <div className="pac-print">
      ...
      <div className="pac-print__header">
        <div className="titulo">
          ...
          <div>
            <h1>Relatório semanal de manutenção — planos executados via OS</h1>
            <div className="sub">
      ...
      {relatorio.secoes.length === 0 && <div className="pac-print__vazio">Nenhum plano de manutenção encontrado para os filtros informados.</div>}
      ...
      {relatorio.secoes.map((secao, i) => (
        <div className="pac-print__secao" key={`${secao.ativo_id}-${secao.origem_codigo}-${i}`}>
          ...
          <div className="origem">
            Setor: {secao.setor} · Plano: <strong>{secao.origem_codigo}</strong> — {secao.origem_descricao}
          </div>
